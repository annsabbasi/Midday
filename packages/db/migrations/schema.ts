import { pgTable, unique, uuid, timestamp, text, smallint, jsonb, boolean, numeric, bigint, date, vector, varchar, json, integer, primaryKey, pgEnum } from "drizzle-orm/pg-core"
...
export const inboxAccountProviders = pgEnum("inbox_account_providers", ['gmail'])
